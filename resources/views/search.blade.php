                    ...
                    <div class="listing-list">
                        <div class="flat-product clearfix">
                            <div class="featured-product">
                                <img src="{{ asset('public/front/images/services/l1.jpg') }}" alt="image">
                                <div class="time">
                                    Now Close
                                </div>
                            </div>
                        ...
                        <div class="flat-product clearfix">
                            <div class="featured-product">
                                <img src="{{ asset('public/front/images/services/l2.jpg') }}" alt="image">
                                <div class="time">
                                    Now Close
                                </div>
                            </div>
                        ...
                        <div class="flat-product clearfix">
                            <div class="featured-product">
                                <img src="{{ asset('public/front/images/services/l3.jpg') }}" alt="image">
                        ...
                        <div class="flat-product clearfix">
                            <div class="featured-product">
                                <img src="{{ asset('public/front/images/services/l4.jpg') }}" alt="image">
                                <div class="time">
                                    Now Close
                                </div>
                            </div>
                        ...
                        <div class="flat-product clearfix">
                            <div class="featured-product">
                                <img src="{{ asset('public/front/images/services/l5.jpg') }}" alt="image">
                                <div class="time">
                                    Now Close
                                </div>
                            </div>
                        ...
                        <div class="flat-product clearfix">
                            <div class="featured-product">
                                <img src="{{ asset('public/front/images/services/l6.jpg') }}" alt="image">
                                <div class="time bg-green">
                                    Now Open
                                </div>
                            </div>
